    ...
    <div class="container">
        <form class="mt-7">
            <div class="flex flex-col gap-2 mt-1">
                <label for="client_name" class="font-serif">Client Name</label>
            ...
            <div class="flex flex-col gap-2 mt-2">
                ...
                <input name="commited_amount" class="font-sans rounded border-primary-800" type="text" id="commited_amount" bind:value={commitedAmountDisplay} on:input={updateCommittedAmount} >
            </div>
            <div class="flex flex-col gap-2 mt-2">
